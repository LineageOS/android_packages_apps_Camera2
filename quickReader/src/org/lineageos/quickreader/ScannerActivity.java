...
public class ScannerActivity extends Activity implements ZXingScannerView.ResultHandler {
    ...
    protected void onCreate(Bundle savedInstance) {
        ...
        mIdentifyLayout = findViewById(R.id.identify_layout);
        mIdentifyIcon = findViewById(R.id.identify_icon);
        mFlashIcon = findViewById(R.id.action_flash);
        ImageView closeIcon = findViewById(R.id.action_close);
    ...
    public void onPause() {
        ...
        try {
            if (mScanView.getFlash()) {
                ...
                mFlashIcon.setImageResource(R.drawable.ic_qr_flash_off);
            }
    ...
    private void toggleFlash() {
        ...
        mFlashIcon.setImageResource(isEnabled ?
            R.drawable.ic_qr_flash_off : R.drawable.ic_qr_flash_on);
    }
